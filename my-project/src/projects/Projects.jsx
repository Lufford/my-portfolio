        ...
        <>
            <div className="min-h-screen flex flex-col items-center justify-center gap-10 p-10 bg-stone-800">
                ...
                <div className="bg-stone-900 max-w-90 p-6 border-1 rounded flex flex-col items-center gap-2.5">
                    <Link to="/video-project" className="text-blue-600 hover:text-blue-400">Youtube Share List</Link>
                ...
                <div className="bg-stone-900 max-w-90 p-6 border-1 rounded flex flex-col items-center gap-2.5">
                    <a href="https://github.com/Lufford/Fly-Me-Through-the-Room" className="text-blue-600 hover:text-blue-400">Fly Me Through the Room</a>
